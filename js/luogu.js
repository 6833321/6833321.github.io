...
(function(){'use strict';var BGI = '',BGC = '',FIL = '';// 修改下面的代码可实现自定义
    function changeColors(){//↓ 更改这里的八个十六进制颜色即可更改洛谷相应版块的颜色
        ...
        const bgc = '#ffffffe0';// 洛谷各个页面卡片颜色（后两位是不透明度）（洛谷原版是 #ffffffff，不想更改就填 #ffffffff）
        const chm = 0;// 是否更改私信中消息的背景（为 1 的话就将背景设成卡片颜色）
        const opt = 2;// 是否更改页面的背景（0 或 1 或 2，0 表示不更改，仍保持原来的灰色；1 表示更改为纯色；2 表示更改为图片）
        const bgc1 = '#e8f9f8';// 如果 opt 为 1，要更改的背景颜色（#efefef 是洛谷默认背景色）（顺带一提，这个背景色其实是和 https://www.luogu.com.cn/theme/design/98289 相匹配的）
        const bgi2 = 'url("https://cdn.luogu.com.cn/upload/image_hosting/hfc31tf2.png")';// 如果 opt 为 2，要更改的背景图片链接（更改双引号中间的内容即可）
        ...
        */
        ...
        if(forumElement){
            // 获取所属板块的文本内容
            const forumTextElement = forumElement.querySelector("a[data-v-bade3303][data-v-0fca37c7]");//console.log(1);
            if(forumTextElement){
        ...
        if(window.location.href.includes("/discuss")){/*
            ...
            var cff=document.querySelectorAll("a[data-v-bade3303][data-v-88d5ecf4].wrap");
            for(let x of cff){
            ...
            //20241116 竖屏时上方选择框
            cff=document.querySelectorAll("a[data-v-bade3303][data-v-88d5ecf4][data-v-a623cdfc][data-v-7daab60c-s].wrap");
            for(let x of cff){
                if(x.innerHTML.includes("全部板块"))x.style.cssText = `--link-indicator-color: ${newcolor1}; color: var(--link-indicator-color);`;
                else if(x.innerHTML.includes("站务版"))x.style.cssText = `--link-indicator-color: ${newcolor2}; color: var(--link-indicator-color);`;
                else if(x.innerHTML.includes("题目总版"))x.style.cssText = `--link-indicator-color: ${newcolor3}; color: var(--link-indicator-color);`;
            ...
            //20241115 专栏区
            //左侧的
            cff=document.querySelectorAll("a[data-v-bade3303][data-v-88d5ecf4][data-v-a623cdfc].wrap");
            for(let x of cff){
            ...
            //右侧的
            let cccc=document.querySelectorAll("div[data-v-83fd4045].row-wrap div[data-v-e01570a1][data-v-291a2998][data-v-7af121b4][data-v-83fd4045-s].l-card");
            for (let el of cccc) {let ee=el.querySelector("span[data-v-c83b85a7][data-v-291a2998]");
                if (ee&&ee.textContent.includes("全部")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol1))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("题解")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol2))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("科技·工程")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol3))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("算法·理论")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol4))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("生活·游记")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol5))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("学习·文化课")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol6))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("休闲·娱乐")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol7))}C0; color: var(--link-indicator-color);`;
                } else {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(articol0))}C0; color: var(--link-indicator-color);`;
                }
            }
        }
        ...
        if(!window.location.href.startsWith('https://www.luogu.com.cn/blog/')){
            ...
            temp1 = document.querySelectorAll("span[data-v-c83b85a7][data-v-291a2998]");
            for(let temp2 of temp1){
                temp2.style.backgroundColor = bgc.slice(0, -2);
            }
            ...
            temp1 = document.querySelectorAll("div[data-v-e01570a1][data-v-7af121b4].l-card:not([data-v-83fd4045-s])");
            for(let temp2 of temp1){
                temp2.style.backgroundColor = bgc;
            }
            ...
            let temp2=temp1;
            if(temp2)temp2.style.backgroundColor = averageHexColor(bgc.slice(0,-2)+"cf",bgc);
            ...
            temp1 = document.querySelectorAll("input");
            for(let temp2 of temp1){
                temp2.style.backgroundColor = bgc.slice(0, -2);
                temp2.style.color = txtc;
                temp2.style.caretColor = txtc;
            ...
            temp1 = document.querySelectorAll("[data-v-0a88bc8f]:not(a[data-v-bade3303]):not([data-v-f21de448])");
            for(let temp2 of temp1){
                temp2.style.color = txtc;
            }
            ...
            temp1 = document.querySelectorAll("a[data-v-bade3303][data-v-c1098b6a]");
            for(let temp2 of temp1){
                temp2.style.color = txtc;
            }
            ...
            temp1 = document.querySelectorAll("div[data-v-291a2998].row.title a[data-v-bade3303]");
            for(let temp2 of temp1){
                temp2.style.color = txtc;
            }
            ...
            temp1 = document.querySelectorAll("[data-v-1bcc9ca7]:not(a[data-v-bade3303])");
            for(let temp2 of temp1){
                temp2.style.color = txtc;
            }
            ...
            for(let temp2 of temp1){
                ...
                imgElements.forEach(imgElement => {
                    ...
                    // 在SVG文本中查找并替换颜色
                    const modifiedSvgText = originalSvgText.replace(/fill: rgba\(0,0,0,0.85\);/g, newFillColor);
        ...
        if(ch1){
            //下面是右侧帖子的
            let c=document.querySelectorAll("div[data-v-83fd4045].row-wrap div[data-v-e01570a1][data-v-83fd4045-s].l-card:not(.comment)");
            for (let el of c) {var ee=el.querySelector("a.router-link-active.wrap");
                if (ee&&ee.textContent.includes("站务版")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor2))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("题目总版")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor3))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("学术版")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor4))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("灌水区")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor5))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("工单反馈版")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor6))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("小黑屋")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor7))}C0; color: var(--link-indicator-color);`;
                } else if (ee&&ee.textContent.includes("团队")) {
                    el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor8))}C0; color: var(--link-indicator-color);`;
                } else {// 题目讨论区
                    //洛谷的bug，目前不会显示小黑屋和团队，所以要重搞
                    var temp=document.querySelector("h1.lfe-h1");
                    if (temp&&temp.textContent.includes("小黑屋"))el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor7))}C0; color: var(--link-indicator-color);`;
                    else if(temp&&temp.textContent.includes("团队"))el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor8))}C0; color: var(--link-indicator-color);`;
                    else if(temp)el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor3))}C0; color: var(--link-indicator-color);`;
                }
            }//改背景色
            //下面是首页的
            ...
            for (let el of c) {
                ...
                if(x){
                    ...
                    if (x&&x.innerHTML.includes("站务版")) {
                        ...
                        if(!window.location.href.includes("article"))el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor3))}C0; color: var(--link-indicator-color);`;
                            ...
                            if (x&&x.textContent.includes("题解")) {
                                ...
                                el.style.cssText=`background-color: ${lighterColor(lighterColor(articol8))}C0; color: var(--link-indicator-color);`;
                            } else if (x&&x.textContent.includes("闲话")) {
                                el.style.cssText=`background-color: ${lighterColor(lighterColor(articol9))}C0; color: var(--link-indicator-color);`;
                            }
                        }
                    }
                }
            ...
            for(let el of c)el.style.cssText=`background-color: ${lighterColor(lighterColor(newcolor8))}C0; color: var(--link-indicator-color);`;
        }
        ...
        tmp1 = document.querySelectorAll('a[data-v-bade3303][data-v-ea62153a]');
        if(tmp1){
        ...
        tmp1 = document.querySelectorAll("span[data-v-c83b85a7][data-v-79cbc3ff]");
        ...
        tmp1 = document.querySelectorAll('div[data-v-83fd4045].row-wrap div.time');
        if(tmp1){
            for(let ssb2 of tmp1)ssb2.style.color = averageHexColor(txtc,bgc);
        }
